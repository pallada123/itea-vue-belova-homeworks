...
export default {
  ...
  methods: {
    ...
    /**
     * Отправляет в родительский компонент событие отключения режима редактирования задачи.
     */
    cancelEditing() {
    ...
    /**
     * Валидирует поля задачи.
     * Отправляет в родительский компонент событие сохранения задачи.
     */
    saveTask() {
      this.imgError = false;
    ...
    /**
     * Валидирует ссылку на изображение.
     * @param url
     * @returns {boolean}
     */
    checkImg(url) {
